"""
VizWiz-VQA Evaluation: Visual QA from blind users with EvalAI VQA-style accuracy.
HF: lmms-lab/VizWiz-VQA
Usage: python examples/eval/vizwiz_vqa/eval_vizwiz_vqa.py --model_path Qwen/Qwen2.5-VL-3B-Instruct --output_dir results/vizwiz_vqa
"""
